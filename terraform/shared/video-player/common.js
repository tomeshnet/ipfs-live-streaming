...
m3u8_ipfs='live.m3u8';  // File path to m3u8 with IPFS content via HTTP server
//m3u8_ipfs='__IPFS_GATEWAY_ORIGIN__/ipns/__IPFS_ID_ORIGIN__';  // URL to m3u8 via IPNS (uncomment to enable)
